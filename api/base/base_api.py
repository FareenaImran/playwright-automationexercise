...
class BaseAPI:
    ...
    def put(self,end_point,params=None):
        return self.request.put(f"{read_config('basic_info', 'base_url')}{end_point}", form=params)

    def delete(self,end_point,params=None):
        return self.request.delete(f"{read_config('basic_info', 'base_url')}{end_point}", form=params)
